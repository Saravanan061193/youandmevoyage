  ...
  await prisma.destination.createMany({
    data: [
      ...
      },
      {
        ...
        highlights: JSON.stringify(['Brihadeeswarar Temple', 'Thanjavur Maratha Palace', 'Saraswathi Mahal Library', 'Royal Art Gallery']),
        experiences: JSON.stringify(['Tanjore painting workshop', 'Chola bronze casting demonstration', 'Classical Veena music experience']),
        duration: '2 Days',
        order: 4,
      },
      {
        ...
        highlights: JSON.stringify(['Meenakshi Amman Temple', 'Thirumalai Nayakar Palace', 'Gandhi Memorial Museum', 'Vandiyur Mariamman Teppakulam']),
      ...
      },
      {
        ...
        highlights: JSON.stringify(['Karaikudi Mansions', 'Athangudi Tile Factories', 'Chettinad Heritage Museum', 'Pillar Mansions of Kanadukathan']),
        experiences: JSON.stringify(['Banana leaf Chettinad feast', 'Heritage mansion walk', 'Handloom silk saree weaving']),
        duration: '2 Days',
        order: 6,
      },
      {
        ...
        experiences: JSON.stringify(['Tea plucking with locals', 'Spice estate trek', 'Cozy tea bungalow stays']),
        duration: '2-3 Days',
        order: 7,
      },
      {
      ...
      },
      {
        ...
        highlights: JSON.stringify(['Fort Kochi Chinese Fishing Nets', 'Mattancherry Dutch Palace', 'Paradesi Synagogue', 'St. Francis Church']),
        experiences: JSON.stringify(['Kathakali dance performance', 'Sunset harbour cruise', 'Jew Town antique shopping']),
        duration: '2 Days',
        order: 9,
      },
      {
        ...
        highlights: JSON.stringify(['Vivekananda Rock Memorial', 'Thiruvalluvar Statue', 'Kanyakumari Amman Temple', 'Sunset Point Cape Comorin']),
        experiences: JSON.stringify(['Ferry ride to Rock Memorial', 'Tri-sea sunset & sunrise watching', 'Beachfront shell craft shopping']),
        duration: '1-2 Days',
        order: 10,
      },
    ],
