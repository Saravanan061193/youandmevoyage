  ...
  const videoCards = [
    {
      ...
      title: settings?.socialCard1Title || 'Majestic Coastal & Heritage Highlights',
    ...
    },
    {
      ...
      title: settings?.socialCard2Title || 'Tranquil Backwater & Private Boat Journeys',
    ...
    },
    {
      ...
      title: settings?.socialCard3Title || '4K Private South India Road Trip Vlogs',
    ...
    },
    {
      ...
      title: settings?.socialCard4Title || 'South India Scenic & Cultural Moments',
