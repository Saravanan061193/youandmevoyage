  ...
  try {
    ...
    try {
      const dbPromise = prisma.blogPost.create({
        data: {
          ...
          content,
          coverImage,
          author: author || 'Discovery Safaris Team',
          authorRole: authorRole || 'Safari Specialist',
          category: category || 'Travel Guide',
          readTime: readTime || '5 min read',
          metaTitle: metaTitle || `${title} | Discovery Safaris Namibia`,
    ...
    if (!createdBlog) {
      createdBlog = {
        ...
        excerpt: excerpt || '',
        content: content || '',
        coverImage: coverImage || 'https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200&q=85',
        author: author || 'Discovery Safaris Team',
        authorRole: authorRole || 'Safari Specialist',
        category: category || 'Travel Guide',
        readTime: readTime || '5 min read',
