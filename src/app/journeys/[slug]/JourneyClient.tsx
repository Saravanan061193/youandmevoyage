...
export function JourneyClientContent({ journey, slug }: { journey: any; slug: string }) {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative h-[65vh] bg-[#0F172A] flex items-end pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <img
          src={journey.image || '/images/placeholder.jpg'}
          alt={journey.title}
...
export function JourneyClient({ journey, slug }: { journey: any; slug: string }) {
  return (
    <CurrencyProvider>
      <JourneyClientContent journey={journey} slug={slug} />
    </CurrencyProvider>
  );
}
