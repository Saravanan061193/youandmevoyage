...
export function DestinationClientContent({ dest, slug }: { dest: any; slug: string }) {
...
export function DestinationClient({ dest, slug }: { dest: any; slug: string }) {
  return (
    <CurrencyProvider>
      <DestinationClientContent dest={dest} slug={slug} />
    </CurrencyProvider>
  );
}
