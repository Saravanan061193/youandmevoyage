...
export const DEFAULT_DESTINATIONS: DestinationItem[] = [
  ...
  },
  {
    ...
    highlights: '["Bangalore Palace","Lalbagh Botanical Garden","Cubbon Park","Vidhana Soudha"]',
    experiences: '["Artisanal cafe hopping","Garden walks","Silk saree shopping"]',
    duration: '2 Days',
    order: 7,
  },
  {
    ...
    highlights: '["Basilica of Bom Jesus","Fontainhas Latin Quarter","Palolem Beach","Mandovi River Cruise"]',
    experiences: '["Spice farm feast","Beach sunset dining","Heritage villa stay"]',
    duration: '3-4 Days',
    order: 8,
  },
];
